...
class Histos(object):
	...
	def __init__(self, currentCutString, outputFileObject):
		...
		self.W_Pt = Histogram(outputFileObject, "HWpt"+currentCutString,"W-Boson pT "+currentCutString,100,0,100)
		self.B_Pt = Histogram(outputFileObject, "HBpt"+currentCutString,"B-Quark pT "+currentCutString,100,0,100)
		self.H_Pt = Histogram(outputFileObject, "HHpt"+currentCutString,"Higgs pT "+currentCutString,100,0,100)
		self.T_Pt = Histogram(outputFileObject, "HTpt"+currentCutString,"Top pT "+currentCutString,100,0,100)
		...
		self.T_E = Histogram(outputFileObject, "HTE"+currentCutString,"Top Energy "+currentCutString,100,0,300)
		self.W_deltaPhi = Histogram(outputFileObject, "HWdeltaPhi"+currentCutString,"W-Boson deltaPhi "+currentCutString,100,-pi,pi)
		self.B_deltaPhi = Histogram(outputFileObject, "HBdeltaPhi"+currentCutString,"B-Quark deltaPhi "+currentCutString,100,-pi,pi)
		self.H_deltaPhi = Histogram(outputFileObject, "HHdeltaPhi"+currentCutString,"Higgs deltaPhi "+currentCutString,100,-pi,pi)
		self.T_deltaPhi = Histogram(outputFileObject, "HTdeltaPhi"+currentCutString,"Top deltaPhi "+currentCutString,100,-pi,pi)
		
		self.W_Hadronic_Pt = Histogram(outputFileObject, "HWHpT"+currentCutString,"W-Boson Hadronic pT "+currentCutString,100,0,100)
		self.W_Hadronic_E = Histogram(outputFileObject, "HWHE"+currentCutString,"W-Boson Hadronic Energy "+currentCutString,100,0,300)
		self.W_Leptonic_Pt = Histogram(outputFileObject, "HWLpT"+currentCutString,"W-Boson Leptonic pT "+currentCutString,100,0,100)
		...
		self.W_Leptonic_e_Pt = Histogram(outputFileObject, "HWLepT"+currentCutString,"W-Boson -> Electron pT "+currentCutString,100,0,100)
		...
		self.W_Leptonic_nue_Pt = Histogram(outputFileObject, "HWLnuepT"+currentCutString,"W-Boson -> nu_e pT "+currentCutString,100,0,100)
		...
		self.W_Leptonic_mu_Pt = Histogram(outputFileObject, "HWLmupT"+currentCutString,"W-Boson -> Muon pT "+currentCutString,100,0,100)
		...
		self.W_Leptonic_numu_Pt = Histogram(outputFileObject, "HWLnumupT"+currentCutString,"W-Boson -> nu_mu pT "+currentCutString,100,0,100)
		...
		self.W_Leptonic_t_Pt = Histogram(outputFileObject, "HWLtpT"+currentCutString,"W-Boson -> Tauon pT "+currentCutString,100,0,100)
		...
		self.W_Leptonic_nut_E = Histogram(outputFileObject, "HWLnutE"+currentCutString,"W-Boson -> nu_t Energy "+currentCutString,100,0,100)
		...
		self.W_M = Histogram(outputFileObject, "HWM"+currentCutString,"W-Boson mass "+currentCutString,100,50,100)
		self.B_M = Histogram(outputFileObject, "HBM"+currentCutString,"B-Quark mass "+currentCutString,100,0,10)
		self.H_M = Histogram(outputFileObject, "HHM"+currentCutString,"Higgs mass "+currentCutString,100,100,150)
		self.T_M = Histogram(outputFileObject, "HTM"+currentCutString,"Top mass "+currentCutString,100,150,200)
		...
		self.MEREjetenergy = Histogram(outputFileObject, "HMEREjetenergy"+currentCutString, "Energy of ME add jets"+currentCutString,100,0,300)
		self.MEREjetpt = Histogram(outputFileObject, "HMEREjetpt"+currentCutString, "Pt of ME add jets "+currentCutString,100,0,300)
		...
		self.nMEREJets = Histogram(outputFileObject, "HnMEREJets"+currentCutString,"Number of ME add jets "+currentCutString, 15, -0.5, 14.5)
